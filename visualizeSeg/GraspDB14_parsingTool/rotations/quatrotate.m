...
function newmat = quatrotate ( mat3xn, quat4x1 )
% rotate each column of a matrix by quaternion
%
% 
...
temp = quatmult( quatmult(quat4x1, [zeros(1,n);mat3xn]), quatinvert(quat4x1) );
newmat = temp(2:4,:);
