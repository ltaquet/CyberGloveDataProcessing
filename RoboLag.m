...
sets = ["1valid", "2valid","3valid","4valid","5valid","6valid","7valid","7valid","9valid","10valid","11valid","12valid","13valid","14valid","15valid","16valid","17valid","18valid","19valid","20valid","22valid","23valid","24valid","25valid","26valid","27valid","28valid","29valid" ];
%sets = ["1validR", "2validR","3validR","4validR","5validR","6validR","7validR","8validR","9validR","10validR","11validR","12validR","13validR","14validR","15validR","16validR","17validR","18validR","19validR","20validR","21validR","22validR","23validR","24validR","25validR","26validR","27validR","28validR","29validR" ];
alags = [];

ci = zeros(length(sets),2);
...
ts = tinv([0.025  0.975],length(lags)-1);
...
%              
%     end
    ci(s,:) = mean(lags) + ts*SEM;
    date(s) = startClocks(1);
